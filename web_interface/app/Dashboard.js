...
export default function Dashboard() {
  ...
  // Format numbers - consistent format to avoid hydration mismatch
  ...
  // Format number with comma separator (consistent, no locale dependency)
  ...
  // Format time consistently (no locale dependency)
            ...
            {indodaxSummary && (
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                ...
                <div className="glass-card rounded-xl p-4">
                  ...
                  <p className="text-lg font-mono text-orange-400">Rp {formatWithComma(indodaxSummary.usd_idr_rate)}</p>
                </div>
              </div>
            )}
                      ...
                      {indodaxTokens.map((token, index) => (
                        ...
                        >
                          ...
                          <td className="p-4 text-right font-mono text-white">
                            Rp {formatWithComma(token.price_idr)}
                          </td>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-400">Current: Rp {formatWithComma(aiForecast.current_price)}</p>
                        </div>
                      </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center gap-2 mb-4 text-xs">
                      ...
                      <span className="text-slate-500 ml-2">
                        ({formatWithComma(aiForecast.total_candles)} candles)
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="p-4 rounded-xl bg-slate-800/50 text-center">
                        ...
                        <p className="text-lg font-mono text-white">Rp {formatWithComma(aiForecast.predicted_price_1h)}</p>
                      ...
                      <div className="p-4 rounded-xl bg-slate-800/50 text-center">
                        ...
                        <p className="text-lg font-mono text-white">Rp {formatWithComma(aiForecast.predicted_price_4h)}</p>
                      ...
                      <div className="p-4 rounded-xl bg-slate-800/50 text-center">
                        ...
                        <p className="text-lg font-mono text-white">Rp {formatWithComma(aiForecast.predicted_price_24h)}</p>
